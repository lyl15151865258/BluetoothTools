...
/**
 * Created by LiYuliang on 2017/2/23 0023
 */

public class InputAlarmEnabledDialog extends Dialog {
    private Context context;
    private View okBtn, cancelBtn;
    private OnDialogClickListener dialogClickListener;

    public InputAlarmEnabledDialog(Context context) {
        super(context);
    ...
    private void initalize() {
        ...
        View view = inflater.inflate(R.layout.dialog_input_alarm_enabled, null);
        setContentView(view);
        initWindow();
