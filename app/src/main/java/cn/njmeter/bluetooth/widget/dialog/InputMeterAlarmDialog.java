...
public class InputMeterAlarmDialog extends Dialog {
    private Context context;
    private View okBtn, cancelBtn;
    private OnDialogClickListener dialogClickListener;

    public InputMeterAlarmDialog(Context context) {
        super(context);
    ...
    private void initalize() {
        ...
        View view = inflater.inflate(R.layout.dialog_input_write_alarm, null);
        setContentView(view);
        initWindow();
