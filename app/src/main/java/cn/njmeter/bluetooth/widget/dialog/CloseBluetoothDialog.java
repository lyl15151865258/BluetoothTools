package cn.njmeter.bluetooth.widget.dialog;
...
/**
 * Created by LiYuliang on 2017/6/23 0023.
 * 关闭蓝牙的弹窗
 */

public class CloseBluetoothDialog extends Dialog {
    private Context context;
    private OnDialogClickListener dialogClickListener;

    public CloseBluetoothDialog(Context context) {
        super(context);
    ...
    private void initalize() {
        ...
        View view = inflater.inflate(R.layout.dialog_close_bluetooth, null);
        setContentView(view);
        initWindow();
        Button okBtn = (Button) findViewById(R.id.btn_ok);
        Button noBtn = (Button) findViewById(R.id.btn_no);
